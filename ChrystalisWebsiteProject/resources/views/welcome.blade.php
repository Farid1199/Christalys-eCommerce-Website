...
-->
      ...
      <div class="row my-5">
        ...
        <div class="col-lg-4">
          <img class="rounded-circle my-4" src="{{ asset('Images\HomePage\2girl.jpg') }}"
        ...
        <!-- /.col-lg-4 -->
        <div class="col-lg-4">
          <img class="rounded-circle my-4" src="{{ asset('Images\HomePage\flavio.png') }}"
            alt="Generic placeholder image" width="140" height="140" />
          <h2>James L.</h2>
          <p>
        ...
        <!-- /.col-lg-4 -->
        <div class="col-lg-4">
          <img class="rounded-circle my-4" src="{{ asset('Images\HomePage\emily.jpg') }}"
            alt="Generic placeholder image" width="140" height="140" />
          <h2>Emily R.</h2>
          <p>
