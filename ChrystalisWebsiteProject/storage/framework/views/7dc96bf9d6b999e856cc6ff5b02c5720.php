...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <header id="main-header" class="shadow">
        <div id="logo" class="ml-5">
            <img src="<?php echo e(asset('Images\CatalogueImg\logo-tp.png'), false); ?>" alt="TopLeft Logo"
        ...
        <nav class="navbar navbar-expand-xl navbar-dark navigation-container">
            ...
            <div class="" id="navbarsExample04">
                <ul class="navbar-nav mr-3 navigation">
                    ...
                    <li class="mr-3"><a href="cartlist">CART(<?php echo e($total, false); ?>)</a></li>
...
<?php $component->withAttributes(['align' => 'right','width' => '48']); ?>
                         <?php $__env->slot('trigger', null, []); ?> 
                            <button
                                ...
                                <div><?php echo e(Auth::user()->name, false); ?></div>
...
=======================
 ...
 <header id="main-header" class="shadow">
      <div id="logo" class="ml-5">
        <img src="<?php echo e(asset('Images\CatalogueImg\logo-tp.png'), false); ?>" alt="TopLeft Logo" style="width: 30%; height: 20%" />
      </div>
      ...
      <nav class="navbar navbar-expand-xl navbar-dark navigation-container">
        ...
        <div class="collapse navbar-collapse" id="navbarsExample04">
          <ul class="navbar-nav mr-auto navigation">
            ...
            <li class="li-log"><a href="<?php echo e(route('register'), false); ?>">SIGN UP</a></li>
...
<?php endif; ?>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                <div class="font-medium text-base text-gray-800"><?php echo e(Auth::user()->name, false); ?></div>
                <div class="font-medium text-sm text-gray-500"><?php echo e(Auth::user()->email, false); ?></div>
            </div>
...
<?php endif; ?>
    ...
    ---><?php /**PATH C:\xampp\htdocs\GitHub\Christalys-eCommerce-Website\ChrystalisWebsiteProject\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>