...
<main role="main">
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img class="first-slide" src="<?php echo e(asset('Images\HomePage\carosel1.png'), false); ?>" alt="First slide" />
        <div class="container">
          <div class="carousel-caption text-left">
            ...
            <p>
              <a class="btn btn-lg btn-primary" href="<?php echo e(route('aboutus'), false); ?>" role="button">About Us</a>
            </p>
          </div>
        </div>
      </div>
      <div class="carousel-item">
        <img class="second-slide" src="<?php echo e(asset('Images\HomePage\carosel1.png'), false); ?>" alt="Second slide" />
        <div class="container">
      ...
      <div class="carousel-item">
        <img class="third-slide" src="<?php echo e(asset('Images\HomePage\carosel1.png'), false); ?>" alt="Third slide" />
        <div class="container">
          <div class="carousel-caption text-right">
            ...
            <p>
              <a class="btn btn-lg btn-primary" href="<?php echo e(route('products'), false); ?>" role="button">Browse Catalogue</a>
            </p>
          </div>
        </div>
      </div>
  ...
  <div class="container marketing" id="down">
    ...
    <div class="row featurette mt-5">
      ...
      <div class="col-md-3">
        <img class="img-fluid mx-auto" src="<?php echo e(asset('Images\CatalogueImg\gold-rings-.png'), false); ?>"
    ...
    <div class="row featurette text-right">
      ...
      <div class="col-md-3 order-md-1">
        <img class="featurette-image img-fluid mx-auto" src="<?php echo e(asset('Images\CatalogueImg\Watch-1.jpg'), false); ?>"
          alt="Generic placeholder image" />
      </div>
    </div>
    ...
    <div class="row featurette">
      ...
      <div class="col-md-3">
        <img class="featurette-image img-fluid mx-auto" src="<?php echo e(asset('Images\CatalogueImg\Neckless1.jpeg'), false); ?>"
          alt="Generic placeholder image" />
      </div>
    </div>
...
-->
    ...
    <section id="yearly-sale" class="bg-light-blue overflow-hidden mt-5 padding-md" style="
        background-image: url('<?php echo e(asset('Images/HomePage/watchbanner.jpg'), false); ?>');
      ...
      <div class="row d-flex flex-wrap align-items-center">
        <div class="col-md-6 col-sm-12">
          <div class="text-content offset-4 padding-medium text-light">
            ...
            <a href="<?php echo e(route('products'), false); ?>" class="btn btn-medium btn-light text-uppercase btn-rounded-none">Shop
              Sale</a>
          </div>
        </div>
...
-->
    ...
    <div class="row my-5">
      ...
      <div class="col-lg-4">
        <img class="rounded-circle my-4" src="<?php echo e(asset('Images\HomePage\2girl.jpg'), false); ?>" alt="Generic placeholder image"
      ...
      <!-- /.col-lg-4 -->
      <div class="col-lg-4">
        <img class="rounded-circle my-4" src="<?php echo e(asset('Images\HomePage\flavio.png'), false); ?>" alt="Generic placeholder image"
          width="140" height="140" />
        <h2>James L.</h2>
        <p>
      ...
      <!-- /.col-lg-4 -->
      <div class="col-lg-4">
        <img class="rounded-circle my-4" src="<?php echo e(asset('Images\HomePage\emily.jpg'), false); ?>" alt="Generic placeholder image"
          width="140" height="140" />
        <h2>Emily R.</h2>
        <p>
