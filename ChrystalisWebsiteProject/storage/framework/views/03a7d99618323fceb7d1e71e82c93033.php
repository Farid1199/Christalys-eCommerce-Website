        ...
        <div class="row justify-content-center">
                ...
                <div class="col mb-2">
                    <div class="card h-100" style="border: 1px solid gold">
                        <!-- Product image-->
                                    <a href = "rings"><img class="card-img-top" src=" <?php echo e(asset('Images\CatalogueImg\gold-rings-.png'), false); ?>" alt="" style="max-width: 100%; height: 200px;"></a>
                ...
                <div class="col mb-2">
                    <div class="card h-100" style="border: 1px solid gold">
                        <!-- Product image-->
                                    <a href = "necklaces"><img class="card-img-top" src=" <?php echo e(asset('Images\CatalogueImg\Neckless1.jpeg'), false); ?>" alt="" style="max-width: 100%; height: 200px;"></a>
                ...
                <div class="col mb-2">
                    <div class="card h-100" style="border: 1px solid gold">
                        <!-- Product image-->
                                    <a href = "bracelets"><img class="card-img-top" src=" <?php echo e(asset('Images\CatalogueImg\bracelet - 2.jpg'), false); ?>" alt="" style="max-width: 100%; height: 200px;"></a>
                ...
                <div class="col mb-2">
                    <div class="card h-100" style="border: 1px solid gold">
                        <!-- Product image--> 
                                    <a href = "earrings "><img class="card-img-top" src=" <?php echo e(asset('Images\CatalogueImg\earrings - 1.jpg'), false); ?>" alt="" style="max-width: 100%; height: 200px;"></a>
                ...
                <div class="col mb-2">
                    <div class="card h-100" style="border: 1px solid gold">
                        <!-- Product image-->
                                    <a href = "watches"><img class="card-img-top" src=" <?php echo e(asset('Images\CatalogueImg\Watch-1.jpg'), false); ?>" alt="" style="max-width: 100%; height: 200px;"></a>
