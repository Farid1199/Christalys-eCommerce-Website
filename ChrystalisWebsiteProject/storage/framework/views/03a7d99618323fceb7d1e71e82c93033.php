                    ...
                    <div class="card h-100" style="border: 2px solid gold">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center">
                                <!-- Product name-->
                                <h5 class="fw-bolder"> <?php echo e(Str::limit($product->name, 20, $end = '...'), false); ?></h5>

                               
                                <!-- Product price-->
                                <h6>Price: £<?php echo e($product->price, false); ?></h6>                            
                            </div>
                        </div>
                        <!-- Product actions-->
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-center">
                                <form action="/detail/<?php echo e($product->id, false); ?>" method="GET">
                                    <?php echo csrf_field(); ?>
