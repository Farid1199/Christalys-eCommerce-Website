<?php if(Admin::user()->visible(\Illuminate\Support\Arr::get($item, 'roles', [])) && Admin::user()->can(\Illuminate\Support\Arr::get($item, 'permission'))): ?>
    ...
    <?php endif; ?>
<?php endif; ?><?php /**PATH C:\xampp\htdocs\Christalys-eCommerce-Website\ChrystalisWebsiteProject\vendor\open-admin-org\open-admin\src/../resources/views/partials/menu.blade.php ENDPATH**/ ?>