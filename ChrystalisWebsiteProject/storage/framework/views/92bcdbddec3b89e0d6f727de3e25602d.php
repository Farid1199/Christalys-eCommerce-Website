...
<div class="relative" x-data="{ open: false }" @click.outside="open = false" @close.stop="open = false">
    ...
    <div x-show="open"
            ...
            class="absolute z-50 mt-2 <?php echo e($width, false); ?> rounded-md shadow-lg <?php echo e($alignmentClasses, false); ?>"
            style="display: none;"
            @click="open = false">
        <div class="rounded-md ring-1 ring-black ring-opacity-5 <?php echo e($contentClasses, false); ?>">
            <?php echo e($content, false); ?>

        </div>
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\GitHub\Christalys-eCommerce-Website\ChrystalisWebsiteProject\resources\views/components/dropdown.blade.php ENDPATH**/ ?>