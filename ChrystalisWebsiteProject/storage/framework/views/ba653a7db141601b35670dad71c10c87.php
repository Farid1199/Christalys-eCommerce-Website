            ...
            <div class="col-lg-10 col-xl-8">
                <div class="card" style="border-radius: 10px;">
                    <div class="card-header px-4 py-5">
                        <h5 class="text-muted mb-0">Thanks for your Order, <span class="text-dark"><?php echo e(Auth::user()->name, false); ?></span>!
                        </h5>
                    </div>
                    <div class="card-body p-4">
                        ...
                        <div class="card shadow-0 border mb-4">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-2">
                                        <img src="<?php echo e(asset('Images\CatalogueImg\gold-rings-.png'), false); ?>" class="img-fluid"
                                            alt="Phone">
                                    </div>
                        ...
                        <div class="d-flex justify-content-between my-2">
                            ...
                            <a href="<?php echo e(route('contactus'), false); ?>"> Customer Support </a>
                        </div>
                        <hr class="my-2">

                        <a class="btn btn-primary btn-xl btn-block mt-3 my-3" href="<?php echo e(route('previousod'), false); ?>">Order
                            History</a>
...
<?php echo $__env->make('mainLayout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\GitHub\Christalys-eCommerce-Website\ChrystalisWebsiteProject\resources\views/order-confirmed.blade.php ENDPATH**/ ?>