    ...
    <div class="row">
        ...
        <div class="col-xl-8 order-md-1">
            ...
            <form class="needs-validation" novalidate>
                ...
                <a class="btn btn-primary btn-lg btn-block py-2 my-3" href="<?php echo e(route('ordercm'), false); ?>">Proceed Payment</a>
            </form>
        </div>
...
<?php echo $__env->make('mainLayout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\GitHub\Christalys-eCommerce-Website\ChrystalisWebsiteProject\resources\views/checkout.blade.php ENDPATH**/ ?>